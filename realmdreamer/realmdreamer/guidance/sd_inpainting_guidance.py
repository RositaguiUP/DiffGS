...
class StableDiffusionInpaintingGuidance(nn.Module):
    ...
    def encode_images(
        ...
        # Enforce device matching (Fixes the CPU/CUDA error!)
    ...
    def sample(
        ...
        # 3. Add noise to the reference scan

...
#define __pyx_kp_u_occlude_pyx __pyx_string_tab[1]
#define __pyx_n_u_Pyx_PyDict_NextRef __pyx_string_tab[2]
#define __pyx_n_u_asyncio_coroutines __pyx_string_tab[3]
#define __pyx_n_u_c_grid __pyx_string_tab[4]
#define __pyx_n_u_c_min_corner __pyx_string_tab[5]
#define __pyx_n_u_c_sizex __pyx_string_tab[6]
#define __pyx_n_u_c_sizey __pyx_string_tab[7]
#define __pyx_n_u_c_sizez __pyx_string_tab[8]
#define __pyx_n_u_c_viewpoint __pyx_string_tab[9]
#define __pyx_n_u_c_voxel_size __pyx_string_tab[10]
#define __pyx_n_u_cline_in_traceback __pyx_string_tab[11]
#define __pyx_n_u_find_occluded_voxels __pyx_string_tab[12]
#define __pyx_n_u_func __pyx_string_tab[13]
#define __pyx_n_u_grid __pyx_string_tab[14]
...
#define __pyx_n_u_min_corner __pyx_string_tab[18]
#define __pyx_n_u_module __pyx_string_tab[19]
#define __pyx_n_u_name __pyx_string_tab[20]
#define __pyx_n_u_occlude __pyx_string_tab[21]
...
#define __pyx_n_u_sizex __pyx_string_tab[26]
#define __pyx_n_u_sizey __pyx_string_tab[27]
#define __pyx_n_u_sizez __pyx_string_tab[28]
#define __pyx_n_u_test __pyx_string_tab[29]
#define __pyx_n_u_values __pyx_string_tab[30]
#define __pyx_n_u_viewpoint __pyx_string_tab[31]
#define __pyx_n_u_voxel_size __pyx_string_tab[32]
#define __pyx_kp_b_iso88591_0q_1_A_a_q_q_q_Qhm_wV __pyx_string_tab[33]
 ...
 *         __Pyx_PyList_SET_ITEM(o, i, item)
*/
    __pyx_t_2 = __pyx_convert_vector_to_py_bool((__pyx_v_v[__pyx_v_i])); if (unlikely(!__pyx_t_2)) __PYX_ERR(1, 91, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_2);
    __Pyx_XDECREF_SET(__pyx_v_item, __pyx_t_2);
    __pyx_t_2 = 0;
...
static PyObject *__pyx_convert_vector_to_py_std_3a__3a_vector_3c_std_3a__3a_vector_3c_bool_3e____3e___(std::vector<std::vector<std::vector<bool> > >  const &__pyx_v_v) {
  ...
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("__pyx_convert_vector_to_py_std_3a__3a_vector_3c_std_3a__3a_vector_3c_bool_3e____3e___", 0);
 ...
 *         __Pyx_PyList_SET_ITEM(o, i, item)
*/
    __pyx_t_2 = __pyx_convert_vector_to_py_std_3a__3a_vector_3c_bool_3e___((__pyx_v_v[__pyx_v_i])); if (unlikely(!__pyx_t_2)) __PYX_ERR(1, 91, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_2);
    __Pyx_XDECREF_SET(__pyx_v_item, __pyx_t_2);
    __pyx_t_2 = 0;
 ...
 *     return v
*/
    __pyx_t_6 = __pyx_convert_vector_from_py_bool(__pyx_v_item); if (unlikely(PyErr_Occurred())) __PYX_ERR(1, 61, __pyx_L1_error)
    try {
      __pyx_v_v.push_back(((std::vector<bool> )__pyx_t_6));
    } catch(...) {
      __Pyx_CppExn2PyErr();
      __PYX_ERR(1, 61, __pyx_L1_error)
    }
...
static std::vector<std::vector<std::vector<bool> > >  __pyx_convert_vector_from_py_std_3a__3a_vector_3c_std_3a__3a_vector_3c_bool_3e____3e___(PyObject *__pyx_v_o) {
  ...
  PyObject *(*__pyx_t_4)(PyObject *);
  PyObject *__pyx_t_5 = NULL;
  std::vector<std::vector<bool> >  __pyx_t_6;
  int __pyx_lineno = 0;
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("__pyx_convert_vector_from_py_std_3a__3a_vector_3c_std_3a__3a_vector_3c_bool_3e____3e___", 0);
 ...
 *     return v
*/
    __pyx_t_6 = __pyx_convert_vector_from_py_std_3a__3a_vector_3c_bool_3e___(__pyx_v_item); if (unlikely(PyErr_Occurred())) __PYX_ERR(1, 61, __pyx_L1_error)
    try {
      __pyx_v_v.push_back(((std::vector<std::vector<bool> > )__pyx_t_6));
    } catch(...) {
      __Pyx_CppExn2PyErr();
      __PYX_ERR(1, 61, __pyx_L1_error)
    }
...
static PyMethodDef __pyx_mdef_7occlude_1find_occluded_voxels = {"find_occluded_voxels", (PyCFunction)(void(*)(void))(__Pyx_PyCFunction_FastCallWithKeywords)__pyx_pw_7occlude_1find_occluded_voxels, __Pyx_METH_FASTCALL|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_7occlude_1find_occluded_voxels(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
PyObject *const *__pyx_args, Py_ssize_t __pyx_nargs, PyObject *__pyx_kwds
#else
PyObject *__pyx_args, PyObject *__pyx_kwds
  ...
  {
    PyObject ** const __pyx_pyargnames[] = {&__pyx_mstate_global->__pyx_n_u_grid,&__pyx_mstate_global->__pyx_n_u_viewpoint,&__pyx_mstate_global->__pyx_n_u_min_corner,&__pyx_mstate_global->__pyx_n_u_voxel_size,&__pyx_mstate_global->__pyx_n_u_sizex,&__pyx_mstate_global->__pyx_n_u_sizey,&__pyx_mstate_global->__pyx_n_u_sizez,0};
    ...
    if (__pyx_kwds_len > 0) {
      ...
      if (__Pyx_ParseKeywords(__pyx_kwds, __pyx_kwvalues, __pyx_pyargnames, 0, values, kwd_pos_args, __pyx_kwds_len, "find_occluded_voxels", 0) < (0)) __PYX_ERR(0, 12, __pyx_L3_error)
      for (Py_ssize_t i = __pyx_nargs; i < 7; i++) {
        if (unlikely(!values[i])) { __Pyx_RaiseArgtupleInvalid("find_occluded_voxels", 1, 7, 7, i); __PYX_ERR(0, 12, __pyx_L3_error) }
      }
  ...
  __Pyx_RaiseArgtupleInvalid("find_occluded_voxels", 1, 7, 7, __pyx_nargs); __PYX_ERR(0, 12, __pyx_L3_error)
  __pyx_L6_skip:;
...
static PyObject *__pyx_pf_7occlude_find_occluded_voxels(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_grid, PyObject *__pyx_v_viewpoint, PyObject *__pyx_v_min_corner, PyObject *__pyx_v_voxel_size, PyObject *__pyx_v_sizex, PyObject *__pyx_v_sizey, PyObject *__pyx_v_sizez) {
  ...
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("find_occluded_voxels", 0);
...
*/
  __pyx_t_1 = __pyx_convert_vector_from_py_std_3a__3a_vector_3c_std_3a__3a_vector_3c_bool_3e____3e___(__pyx_v_grid); if (unlikely(PyErr_Occurred())) __PYX_ERR(0, 15, __pyx_L1_error)
...
*/
  __pyx_t_2 = __pyx_convert_vector_from_py_int(__pyx_v_viewpoint); if (unlikely(PyErr_Occurred())) __PYX_ERR(0, 16, __pyx_L1_error)
...
*/
  __pyx_t_2 = __pyx_convert_vector_from_py_int(__pyx_v_min_corner); if (unlikely(PyErr_Occurred())) __PYX_ERR(0, 17, __pyx_L1_error)
...
*/
  __pyx_t_3 = __Pyx_PyFloat_AsFloat(__pyx_v_voxel_size); if (unlikely((__pyx_t_3 == (float)-1) && PyErr_Occurred())) __PYX_ERR(0, 18, __pyx_L1_error)
...
*/
  __pyx_t_4 = __Pyx_PyLong_As_int(__pyx_v_sizex); if (unlikely((__pyx_t_4 == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 19, __pyx_L1_error)
...
*/
  __pyx_t_4 = __Pyx_PyLong_As_int(__pyx_v_sizey); if (unlikely((__pyx_t_4 == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 20, __pyx_L1_error)
 ...
 *     return findOccludedVoxels(c_grid, c_viewpoint, c_min_corner, c_voxel_size, sizex, sizey, sizez)
*/
  __pyx_t_4 = __Pyx_PyLong_As_int(__pyx_v_sizez); if (unlikely((__pyx_t_4 == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 21, __pyx_L1_error)
...
*/
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_4 = __Pyx_PyLong_As_int(__pyx_v_sizex); if (unlikely((__pyx_t_4 == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 22, __pyx_L1_error)
  __pyx_t_5 = __Pyx_PyLong_As_int(__pyx_v_sizey); if (unlikely((__pyx_t_5 == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 22, __pyx_L1_error)
  __pyx_t_6 = __Pyx_PyLong_As_int(__pyx_v_sizez); if (unlikely((__pyx_t_6 == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 22, __pyx_L1_error)
  __pyx_t_7 = __pyx_convert_vector_to_py_std_3a__3a_vector_3c_std_3a__3a_vector_3c_bool_3e____3e___(findOccludedVoxels(__pyx_v_c_grid, __pyx_v_c_viewpoint, __pyx_v_c_min_corner, __pyx_v_c_voxel_size, __pyx_t_4, __pyx_t_5, __pyx_t_6)); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 22, __pyx_L1_error)
...
__Pyx_RefNannySetupContext("PyInit_occlude", 0);
  ...
  }
  {
    ...
    if (!PyDict_GetItemString(modules, "occlude")) {
      if (unlikely((PyDict_SetItemString(modules, "occlude", __pyx_m) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  /*--- Builtin init code ---*/
 ...
 * def find_occluded_voxels(grid, viewpoint, min_corner, voxel_size, sizex, sizey, sizez):
*/
  __pyx_t_2 = __Pyx_CyFunction_New(&__pyx_mdef_7occlude_1find_occluded_voxels, 0, __pyx_mstate_global->__pyx_n_u_find_occluded_voxels, NULL, __pyx_mstate_global->__pyx_n_u_occlude, __pyx_mstate_global->__pyx_d, ((PyObject *)__pyx_mstate_global->__pyx_codeobj_tab[0])); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 12, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  #if CYTHON_COMPILING_IN_CPYTHON && PY_VERSION_HEX >= 0x030E0000
  PyUnstable_Object_EnableDeferredRefcount(__pyx_t_2);
  #endif
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_find_occluded_voxels, __pyx_t_2) < (0)) __PYX_ERR(0, 12, __pyx_L1_error)
...
static int __Pyx_InitConstants(__pyx_mstatetype *__pyx_mstate) {
  CYTHON_UNUSED_VAR(__pyx_mstate);
  {
    const struct { const unsigned int length: 6; } index[] = {{1},{11},{20},{18},{6},{12},{7},{7},{7},{11},{12},{18},{20},{8},{4},{13},{5},{8},{10},{10},{8},{7},{3},{12},{12},{10},{5},{5},{5},{8},{6},{9},{10},{63}};
    #if (CYTHON_COMPRESS_STRINGS) == 2 /* compression: bz2 (316 bytes) */
const char* const cstring = "BZh91AY&SY\330\257g\370\000\000\016\177\376\347\010\000\203\014\001`\001\244\001q\003\277\357\377\360@\000@@@@@\000@@@@@\0000\000\351\2144Jz\200d\0004\320\006\200\000\364ji\247\345B\t\241O\024dyL\200h\000\000\r\250\000%\0214)\350\321\350\325=\250\023 a\003\000\t\210lA\310D\325Z\300X41\326HhM\214\236\331~\232\021&\352a\277XFb\000\376f\347\246%\355\252\005\260\030\276F\006K4\014R$\212\204`\227s\357\347\323\006\220\232C\225\316|\357}\341\245\244\347\214\007o\200Z\221\000i6Y\346\026U\221Q$\330\027\031\212\035\000\254\014\016\304!p\351RY\302%\3620%\277c\310\221u5\000\326\025\262\206\265\250\327**I\222\001FwO\205\310\361C{\207\343JBR\264\177R\356?\016\311\336K\027\2518B\343\335\n\022u\363\203\007\021\222\273\322dZ&\274-.\356\300\364\265\212\242b\322\335[g\363\306J\212vY\225\221\260\\\000\033\212Y\223\344\353Fd\252\375\276#(\225\212\277\305\334\221N\024$6+\331\376\000";
...
const char* const cstring = "x\332MO1N\3040\020\004)\320\334\003\250\270\006\352\023|\000\204D\215\016\n\272cd\326\033\260p\354$\266\357\222\253x\002e\312\224\224<\201\2222e\236\301\023\260\222\3508\027;\243\361\356\354\354\265%\322A\362\"\257+`\031\313\262\276U\344q\307\225\177\340T\270\332\220\262\013\262\245\r^\031v\204\227RIB\246\014\242j\270$8\265\345j\204z\204-a\255x\223[e|\244\266b=\350\244\243\007\342\250/\005\361\263\240\267T\031\211)\205\034;\035\220\006C\0306A9\354\266+\317Y\374\315Dt\330K\020\271\225A3\3423\"\2138\031\3466\007\212 \364\250\002\216\375\324\021\231\214\367\005\355\207\364C\366!9\340\331y`-t`\267\273\342\377\206\367\303\337\343\203\243\213\317\242O\316\332\313>9oo\372d\336\210>9\371(\366\313\254\233\2356\367\315k\233}]}\317\1776\335\343\252[=\375\001\352\334\227\334";
    ...
    if (likely(bytes)); else { Py_DECREF(data); __PYX_ERR(0, 1, __pyx_L1_error) }
    #endif
    #else /* compression: none (371 bytes) */
const char* const bytes = "?occlude.pyx__Pyx_PyDict_NextRefasyncio.coroutinesc_gridc_min_cornerc_sizexc_sizeyc_sizezc_viewpointc_voxel_sizecline_in_tracebackfind_occluded_voxels__func__grid_is_coroutineitems__main__min_corner__module____name__occludepop__qualname____set_name__setdefaultsizexsizeysizez__test__valuesviewpointvoxel_size\200\001\360\006\000\0050\250q\330\004#\2401\330\004$\240A\330\004\036\230a\330\004\027\220q\330\004\027\220q\330\004\027\220q\330\004\013\320\013\035\230Q\230h\240m\260>\300\036\310w\320V]\320]^";
    PyObject *data = NULL;
...
static int __Pyx_CreateCodeObjects(__pyx_mstatetype *__pyx_mstate) {
  ...
  {
    const __Pyx_PyCode_New_function_description descr = {7, 0, 0, 14, (unsigned int)(CO_OPTIMIZED|CO_NEWLOCALS), 12};
    PyObject* const varnames[] = {__pyx_mstate->__pyx_n_u_grid, __pyx_mstate->__pyx_n_u_viewpoint, __pyx_mstate->__pyx_n_u_min_corner, __pyx_mstate->__pyx_n_u_voxel_size, __pyx_mstate->__pyx_n_u_sizex, __pyx_mstate->__pyx_n_u_sizey, __pyx_mstate->__pyx_n_u_sizez, __pyx_mstate->__pyx_n_u_c_grid, __pyx_mstate->__pyx_n_u_c_viewpoint, __pyx_mstate->__pyx_n_u_c_min_corner, __pyx_mstate->__pyx_n_u_c_voxel_size, __pyx_mstate->__pyx_n_u_c_sizex, __pyx_mstate->__pyx_n_u_c_sizey, __pyx_mstate->__pyx_n_u_c_sizez};
    __pyx_mstate_global->__pyx_codeobj_tab[0] = __Pyx_PyCode_New(descr, varnames, __pyx_mstate->__pyx_kp_u_occlude_pyx, __pyx_mstate->__pyx_n_u_find_occluded_voxels, __pyx_mstate->__pyx_kp_b_iso88591_0q_1_A_a_q_q_q_Qhm_wV, tuple_dedup_map); if (unlikely(!__pyx_mstate_global->__pyx_codeobj_tab[0])) goto bad;
  }

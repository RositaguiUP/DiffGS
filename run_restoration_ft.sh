...
--project_name "RealmDreamer_Restoration_Distillation" \
...
--pipeline.densification_interval 100 \
--pipeline.densify_grad_threshold 0.00002 \
...
--pipeline.model.lambda_rgb 10.0 \
--pipeline.model.lambda_rgb_final 10.0 \
--pipeline.model.rgb_start_step 15000 \
--pipeline.model.rgb_lock_step 15000 \
--pipeline.model.lambda_depth 4.0 \
--pipeline.model.lambda_depth_final 4.0 \
--pipeline.model.depth_start_step 15000 \
...
--pipeline.model.lambda_one_step 0.5 \
--pipeline.model.lambda_one_step_perceptual 6.0 \
...
--pipeline.model.start_diff_ratio 0.0 \
--pipeline.model.controlnet_tile_scale 0.97 \
--pipeline.model.controlnet_depth_scale 0.90 \
--pipeline.model.ip_adapter_scale 0.7 \
--optimizers.xyz.optimizer.lr 0.0004 \
--optimizers.f-dc.optimizer.lr 0.001 \
--optimizers.opacity.optimizer.lr 0.04 \
--optimizers.scaling.optimizer.lr 0.002 \
